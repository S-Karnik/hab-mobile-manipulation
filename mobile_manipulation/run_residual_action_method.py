...
from mobile_manipulation.goal_failure_belief.goal_actor_critic.residual_rl_action_skill_sequence import TrainResidualSkillSequence
...
def main():
    ...
    trainer = TrainResidualSkillSequence(composite_task_config=config, skill_config=skill_config, seed=seed, gpu_id=gpu_id)
    trainer.train()
