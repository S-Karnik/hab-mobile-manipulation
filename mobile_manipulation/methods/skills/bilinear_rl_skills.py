...
class BilinearPlaceRLSkill(BilinearRLSkill):
    def reset(self, obs, **kwargs):
        super().reset(obs, **kwargs)
        self._last_step_action_drop = False
    ...
    def act(self, obs, **kwargs):
        ...
        if step_action["action_args"][-1] < 0:
            step_action["action_args"][-1] = 1.0
            self._last_step_action_drop = True
        return step_action

    def should_terminate(self, obs, **kwargs):
        return self._last_step_action_drop
