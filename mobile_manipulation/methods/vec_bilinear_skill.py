...
class Terminate(Skill):
    def act(self, obs, **kwargs):
        self._vec_rl_env.async_call_at(self._vec_rl_env_idx, "set_terminate", {"should_terminate": True})
...
class CompositeSkill(Skill):
    ...
    def __init__(
        ...
        self.skills = self._init_entities(
            ...
            register_func=bmy_registry.get_skill,
